About edffile-feedstock
=======================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/edffile-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5249&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/edffile-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `edffile` can be installed with `conda`:
...
```
mamba install edffile
```

It is possible to list all of the versions of `edffile` available on your platform with `conda`:
...
```
mamba search edffile --channel conda-forge
```
...
mamba repoquery search edffile --channel conda-forge

# List packages depending on `edffile`:
mamba repoquery whoneeds edffile --channel conda-forge

# List dependencies of `edffile`:
mamba repoquery depends edffile --channel conda-forge
```
